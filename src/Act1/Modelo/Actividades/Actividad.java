...
abstract public class Actividad implements Serializable
{
    ...
    public void mostrarInscripciones()
    {
        for (Inscripcion oInsc : lInscripcion)
        {
            ...
            System.out.println("Act1.Modelo.Estudiante Inscripto: " + oEst.getNombre());
    ...
    {
        System.out.println("Act1.Modelo.Actividades.Actividad: " + titulo + " (ID: " + id + ") - Tipo: " + getTipo() + " (Cupo Maximo: " + cupoMaximo + " ) (Cupo Minimo: " + CUPO_MINIMO + " )");

        System.out.println(" ");

        if (getTipo().equals("Act1.Modelo.Actividades.Charla"))
        {
